...
class NewThread2 implements Runnable{
	...
	NewThread2(String name){
		...
		System.out.println("child thread "+t);     //Thread[one,5,main]  ,Thread[two,5,main]   Tread[three,5,main]
		t.start();       //starts one thread and put in runnable stage and comes to main thread
	...
	public void run() {
		...
		System.out.println(tname+" thread exiting ");
	}
